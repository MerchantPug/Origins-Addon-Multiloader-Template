...
3. Add a new 'libs' folder in the base directory. This will contain the Calio Forge and Apoli Forge JARs for use in the build scripts. This is a temporary solution until Edwin uploads these mods to a maven repository.
